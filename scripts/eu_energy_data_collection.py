        ...
        try:
            ...
            if country_code in links and 'data_sheet_id' in links[country_code]:
                ...
                try:
                    ...
                    # through to the Drive search / create-new logic below
                    # instead of silently reopening and writing to a
                    ...
                    if drive_service:
                        ...
                        if file_meta.get('trashed'):
                            print(f"  ⚠ Sheet ID in JSON points to a trashed sheet, will search Drive before creating new")
                            spreadsheet = None
                        else:
