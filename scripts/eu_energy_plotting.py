...
def create_all_charts(all_data, country_code='EU'):
    ...
    for source_name in sources_to_plot:
        ...
        ax1.legend(loc='upper left', bbox_to_anchor=(0.165, 0.15), 
        ...
        ax2.legend(loc='upper left', bbox_to_anchor=(0.165, 0.15),
    ...
    if available_sources and 'Total Generation' in all_data:
        ...
        for period in periods:
            ...
            ax1.legend(reordered_handles, reordered_labels, loc='upper left', bbox_to_anchor=(0.2, 0.15),
            ...
            ax2.legend(reordered_handles, reordered_labels, loc='upper left', bbox_to_anchor=(0.2, 0.15),
    ...
    if all_sources_for_annual and 'Total Generation' in annual_totals:
        ...
        if True:  # Always true since we force all sources
            ...
            ax1.legend(reordered_handles, reordered_labels, loc='upper left', bbox_to_anchor=(0.19, 0.15),
                       bbox_transform=fig1.transFigure, ncol=4,
                       fontsize=18, frameon=False)
        ...
        if True:  # Always true since we force all sources
            ...
            ax2.legend(reordered_handles, reordered_labels, loc='upper left', bbox_to_anchor=(0.19, 0.15),
                       bbox_transform=fig2.transFigure, ncol=4,
                       fontsize=18, frameon=False)
